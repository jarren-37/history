...
import { GAMES } from "@/content/chemistry/games";
import { StationTopBar } from "@/components/science/ui";

export default function ChemistryGamesHub() {
  return (
    <div className="mx-auto max-w-3xl px-4 pb-20 pt-6 sm:px-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {GAMES.map((g) => (
          <Link key={g.slug} href={`/chemistry/games/${g.slug}`} className="block">
            <div
