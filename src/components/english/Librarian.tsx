...
export function useLibrarianLine(): {
  ...
  if (due.length > 0) {
    ...
    return {
      ...
      action: { label: "Revisit words", href: "/english/review" },
    };
  }
  ...
  if (discoveredCount === 0) {
    return {
      ...
      action: { label: "Wake the first word", href: "/english/room/nature" },
    };
  }
  ...
  if (streak.count >= 3) {
    return {
      ...
      action: { label: "Today's adventure", href: "/english/daily" },
    };
  }
  ...
  return {
    ...
    action: { label: "Keep exploring", href: "/english/#halls" },
  };
}
