...
const LINKS = [
  { href: "/english", label: "Great Hall", icon: "🏛️" },
  { href: "/english/collection", label: "Collection", icon: "📚" },
  { href: "/english/games", label: "Games", icon: "🎲" },
  { href: "/english/write", label: "Writing", icon: "🪶" },
  { href: "/english/review", label: "Review", icon: "🔮" },
  { href: "/english/daily", label: "Daily", icon: "🗓️" },
];
            ...
            return (
              ...
              >
                ...
                <span aria-hidden className="relative">
                  {l.icon}
                  {l.href === "/english/review" && dueCount > 0 && (
